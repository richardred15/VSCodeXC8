...
"C:\Program Files (x86)\Microchip\MPLABX\v5.15\gnuBins\GnuWin32\bin\make.exe" -f nbproject/Makefile-default.mk dist/default/production/%2.production.hex
